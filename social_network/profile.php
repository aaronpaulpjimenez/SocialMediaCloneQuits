...
<div class="row">
    ...
    <?php 
        ...
        <label class='btn btn-danger'>Select Cover Image
        <input type='file' name='u_cover' size='60' />
        </label><br><br>
        <button name='submit' class='btn btn-danger'>Update Cover</button>
        </center>
        </div>
        </li>
        </ul>
        ...
        <div id='profile-img'> <img src='users/$user_image' alt='Profile' class='img-circle' width='180px' height='185px'>
        <form action='profile.php?u_id='$user_id' method='post' enctype='multipart/form-data'>
        <label id='update_profile'>Select Profile
        <input type='file' name='u_image' size='60' />
        </label><br><br>
        <button id='button_profile' name='update' class='btn btn-danger'>Update Profile</button>
        </form>
        </div><br>
        ";
        ?>
        ...
        <div class="col-sm-6">
            ...
            while($row_posts = mysqli_fetch_array($run_posts)){
                ...
                if($content == "No" && strlen($upload_image) >= 1){
                    ...
                    <div id='own_posts'>
                    <div class='row'>
                    <div class='col-sm-2'><p><img src='users/$user_image' class='img-circle' width='100px' height='100px'></p></div>
                    <div class='col-sm-6'>
                    ...
                    <a href='funtions/delete_post.php?post_id=$post_id' style= float:right;'><button class='btn btn-danger'>Delete</button></a> 
                    </div><br><br>
                    ";
                }
