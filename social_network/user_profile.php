...
<body>
	<div class="row">
		...
		<div class="col-sm-12">
            ...
            $select = "SELECT * FROM users WHERE user_id='" . mysqli_real_escape_string($con, $user_id) . "'";
    ...
    $get_posts = "SELECT * FROM posts WHERE user_id=" . intval($u_id) . " ORDER BY 1 DESC LIMIT 5";
